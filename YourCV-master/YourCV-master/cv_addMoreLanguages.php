...
<?php 
$additional=  filter_input(INPUT_GET, 'additional');
$additional_cv_id=  filter_input(INPUT_GET, 'id_cv2');
if(isset($additional)&&!empty($additional)&&isset($additional_cv_id)&&!empty($additional_cv_id))
{
    $_SESSION['additional']=1;
    $_SESSION['additional_cv_id']=$additional_cv_id;
...
<form action="cv_addMoreLanguagesSave.php" method="POST">
        <table>
<tr>
     <td>&nbsp;</td>
